              ...
              <div className="mb-8 p-5 bg-indigo-50 border border-indigo-100 rounded-xl flex items-center justify-between gap-4 flex-wrap">
                ...
                <div className="flex gap-3 flex-wrap">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-indigo-700 text-white font-semibold rounded-lg hover:bg-indigo-800 transition-colors text-sm shadow-sm"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-indigo-700 font-semibold rounded-lg border border-indigo-200 hover:bg-indigo-50 transition-colors text-sm"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {paper.fileUrl && (
              <div className="flex justify-center pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-8 py-3 bg-indigo-700 text-white font-bold rounded-xl hover:bg-indigo-800 transition-colors text-base shadow"
                >
