    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-12 w-full">
        ...
        <div className="space-y-6">
          {[{ title: "About the Journal", content: "MediaScholar is a bi-annual, open-access, peer-reviewed bilingual journal (Hindi & English) focused on Media Studies, Mass Communication, Journalism, and related disciplines. ISSN: 3048-5029." },
            ...
            { title: "Publication Fee", content: "MediaScholar does not charge any article processing or submission fees. All accepted articles are published free of charge." },
            { title: "Copyright", content: "Authors retain copyright. By submitting, authors grant MediaScholar the right to publish and distribute the work in both print and digital formats." },
          ].map(s => (
